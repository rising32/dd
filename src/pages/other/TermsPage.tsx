...
function TermsPage() {
  return (
    <MainResponsive className='text-black'>
      <HeaderWithTitle title='Terms of Use' />
      <div className='bg-white mt-4 w-full p-4'>
        ...
        <div>
          ...
          <span className='bg-yellow'>{' France'}</span>, without reference to its conflicts of law principles. All disputes will be subject
          to the exclusive jurisdiction of the courts located in <span className='bg-yellow'>Paris.</span>
